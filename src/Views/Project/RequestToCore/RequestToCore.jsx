...
const RequestToCore = (props) => {
  ...
  async function resetList() {
    const res = await listAllCopyRequests(projectCode, status, 0, 10);
    console.log(res);
    if (res.data.result) {
      ...
      if (res.data.result[0]) {
        ...
        // TODO: check if request has projectId property, requestCompleteAPI relies on this in API call (wait for BFF)
