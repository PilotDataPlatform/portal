...
const defaultLayout = {
  ...
  admin: {
    lg: [
      { i: '2', x: 0, y: 0, w: 3, h: 10 },
      { i: '1', x: 3, y: 0, w: 15, h: 10 },
      { i: '3', x: 18, y: 0, w: 6, h: 10 },
    ],
    md: [
      { i: '2', x: 0, y: 0, w: 5, h: 10 },
      { i: '1', x: 5, y: 0, w: 19, h: 10 },
      { i: '3', x: 0, y: 7, w: 24, h: 10 },
    ],
    sm: [
      { i: '2', x: 0, y: 0, w: 2.5, h: 10 },
      { i: '1', x: 2.5, y: 0, w: 9.5, h: 10 },
      { i: '3', x: 0, y: 7, w: 12, h: 10 },
    ],
  },
  contributor: {
    lg: [
      { i: '2', x: 0, y: 0, w: 3, h: 10 },
      { i: '3', x: 17, y: 0, w: 7, h: 10 },
      { i: '1', x: 3, y: 0, w: 14, h: 10 },
    ],
  },
  collaborator: {
    lg: [
