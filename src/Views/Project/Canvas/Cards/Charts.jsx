...
function Charts(props) {
  ...
  const heatMapGraphs = useMemo(() => ({
    downloads : <HeatMap data={HEATMAP_DOWNLOAD_DATA} color={heatmapColors}/>,
    upload: <HeatMap data={HEATMAP_UPLOAD_DATA} color={heatmapColors}/>,
    delete: <HeatMap data={HEATMAP_DELETE_DATA} color={heatmapColors}/>
    ...
    <div className={styles.charts}>
      ...
      <div className={styles['charts__graphs']}>
        <div className={styles['graphs__container']}>
          ...
          <TabSwitcher contentMap={heatMapGraphs}/>
        </div>
      </div>
    </div>
  );
